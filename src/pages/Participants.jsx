...
import { GroupTypes, ParticipantTypes, getGroupType, getParticipantType } from "../utils/Types";
        ...
        <div className="mb-12">
          ...
          <div className="sm:col-span-1">
              ...
              <div className="mt-2">
                ...
                >
                  <option></option>
                  {ParticipantTypes.map(type => (<option key={type.key} value={type.key}>
                    {type.name}
                  </option>))}
                </select>
              </div>
          ...
          <div className="sm:col-span-1">
              ...
              <div className="mt-2">
                ...
                >
                  <option></option>
                  {GroupTypes.map(type => (<option key={type.key} value={type.key}>
                    {type.name}
                  </option>))}
                </select>
              </div>
          ...
          <div className="sm:col-span-1">
              ...
              <div className="mt-2">
                ...
                >
                  <option></option>
                  {churches.map(church => (<option key={church.id} value={church.id}>
                    {church.name}
                  </option>))}
                </select>
              </div>
